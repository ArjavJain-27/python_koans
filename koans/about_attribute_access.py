...
class AboutAttributeAccess(Koan):
    ...
    class ScarySetter:
    """Demonstrates how __setattr__ intercepts attribute assignments."""
    ...
    def __setattr__(self, attr_name, value):
        """Prefix public attributes with 'altered_' before storing them."""
        new_attr_name = attr_name

        if not attr_name.startswith('_'):
            new_attr_name = f"altered_{attr_name}"
